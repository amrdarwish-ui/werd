...
class AzkarMasaa extends StatefulWidget {
  AzkarMasaa({Key key}) : super(key: key);
      ...
      body: Center(
        ...
        child: Column(
          children: [
            ...
            NewItemCard(
                txt:
                    "للّهُـمَّ ما أَمسى  بي مِـنْ نِعْـمَةٍ أَو بِأَحَـدٍ مِـنْ خَلْـقِك ، فَمِـنْكَ وَحْـدَكَ لا شريكَ لَـك ، فَلَـكَ الْحَمْـدُ وَلَـكَ الشُّكْـر",
                count: 1),
            NewItemCard(
                txt:
            ...
            NewItemCard(
                txt:
                    "أَمْسَيْنا  وَأَمْسَى المُـلكُ للهِ رَبِّ العـالَمـين ، اللّهُـمَّ إِنِّـي أسْـأَلُـكَ خَـيْرَ هَذَه  اللَّيْلَةِ  ، فَـتْحَهُا ، وَنَصْـرَهُا ، وَنـورَهُا وَبَـرَكَتَـهُا ، وَهُـداهُا ، وَأَعـوذُ بِـكَ مِـنْ شَـرِّ ما فـيهِا وَشَـرِّ ما بَعْـدَها",
                count: 1),
            NewItemCard(
                txt:
            ...
            NewItemCard(
                ...
                count: 100),
            NewItemCard(txt: "أسْتَغْفِرُ اللهَ وَأتُوبُ إلَيْهِ", count: 100),
          ],
        ),
      )),
    );
